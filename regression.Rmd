...
```
## QQ-plots of all the Regressions 
...
# Residual QQ-plot for number of years of motherucation
qqnorm(resid(linReg.motheduc), main = "")
qqline(resid(linReg.motheduc), col='red')

# Residual QQ-plot for number of cigarettes smoked by the mother during pregnancy
qqnorm(resid(SLRObjects$cigs), main = "")
qqline(resid(SLRObjects$cigs), col='red')

qqnorm(resid(linearRegression), main = "")
